...
public class QuarkusTestExtension implements BeforeAllCallback, BeforeEachCallback, AfterEachCallback, TestInstanceFactory, IAnnotationDrivenExtension<SpockQuarkusSpec> {
    ...
    @Override
    public void visitSpecAnnotation(SpockQuarkusSpec annotation, SpecInfo spec) {

    }

    @Override
    public void visitFeatureAnnotation(SpockQuarkusSpec annotation, FeatureInfo feature) {

    }

    @Override
    public void visitFixtureAnnotation(SpockQuarkusSpec annotation, MethodInfo fixtureMethod) {

    }

    @Override
    public void visitFieldAnnotation(SpockQuarkusSpec annotation, FieldInfo field) {
